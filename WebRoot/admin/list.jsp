...
<html>
  ...
  <body>
  <center>
  <h2 style="color:#0ae;">财务管理</h2>
  </center>
  <hr/>
  <form name="com" style="padding-bottom:10px">
  	<input type="text"  placeholder="请输入财务姓名" name="name" class="input" style="width:250px; line-height:17px;display:inline-block">
  	<input type="button" value="搜索" onclick="query(0)" class="button border-main icon-search">
  	<a class='button border-main' href='javascript:;' onclick="addUser()">新增财务人员</a>
  </form>
		...
		function query(num){
			...
			if(num == 1){//第一页
			 ...
			 $(document).ready(function(){
			 	//设置提交的路径，和参数
				$.post("<%=path%>/list.do",{"name":name,"pageSize":pageSize,"pageCurrent":pageCurrent},
